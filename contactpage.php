                            ...
                            <div class="card-body" style="background-color:#e4dfdf;">
                              ...
                              <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="judul_ulasan" id="judul_ulasan">
                                      ...
                                      <?php
                                       ...
                                       if ($result) {
                                           // Loop untuk mengambil setiap judul berita
                                           while ($row = mysqli_fetch_assoc($result)) {
                                               $judulBerita = $row['judul_berita'];
                                               // Tampilkan judul berita sebagai opsi dalam dropdown
                                               echo "<option value=\"$judulBerita\">$judulBerita</option>";
                                           }
